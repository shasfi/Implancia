...
const PRODUCTS_PRICING = {
  'safety-locking-screw': {
    basePrice: 0.99,
    optionLabels: { material: 'Material', diameter: 'Diameter', option3: 'Length', option4: 'Head Type' },
    material: [
    ...
    diameter: [
      ...
      { value: '2.4', label: '2.4 mm', modifier: 0, lengths: [
        ...
        { value: '22', label: '22 mm', modifier: 0 },
        { value: '24', label: '24 mm', modifier: 0 },
        { value: '26', label: '26 mm', modifier: 0 },
        { value: '28', label: '28 mm', modifier: 0 },
        { value: '30', label: '30 mm', modifier: 0 },
        { value: '32', label: '32 mm', modifier: 0 },
        { value: '34', label: '34 mm', modifier: 0 },
        { value: '36', label: '36 mm', modifier: 0 },
        { value: '38', label: '38 mm', modifier: 0 },
        { value: '40', label: '40 mm', modifier: 0 }
      ] },
      { value: '2.7', label: '2.7 mm', modifier: 0, lengths: [
        { value: '6', label: '6 mm', modifier: 0 },
        { value: '8', label: '8 mm', modifier: 0 },
        { value: '10', label: '10 mm', modifier: 0 },
        { value: '12', label: '12 mm', modifier: 0 },
      ...
      { value: '3.5', label: '3.5 mm', modifier: 0, lengths: [
        { value: '10', label: '10 mm', modifier: 0 },
        { value: '12', label: '12 mm', modifier: 0 },
        { value: '14', label: '14 mm', modifier: 0 },
        { value: '16', label: '16 mm', modifier: 0 },
        ...
        { value: '38', label: '38 mm', modifier: 0 },
        { value: '40', label: '40 mm', modifier: 0 },
        { value: '42', label: '42 mm', modifier: 0 },
        { value: '44', label: '44 mm', modifier: 0 },
        { value: '46', label: '46 mm', modifier: 0 },
        { value: '48', label: '48 mm', modifier: 0 },
        { value: '50', label: '50 mm', modifier: 0 },
        { value: '52', label: '52 mm', modifier: 0 },
        { value: '54', label: '54 mm', modifier: 0 },
        { value: '56', label: '56 mm', modifier: 0 },
        { value: '58', label: '58 mm', modifier: 0 },
        { value: '60', label: '60 mm', modifier: 0 }
      ] },
      { value: '4.5', label: '4.5 mm', modifier: 0.3, lengths: [
        { value: '10', label: '10 mm', modifier: 0 },
        { value: '12', label: '12 mm', modifier: 0 },
        { value: '14', label: '14 mm', modifier: 0 },
        { value: '16', label: '16 mm', modifier: 0 },
    ...
    option4: [
      { value: 'star-head', label: 'Star Head', modifier: 0 },
      { value: 'hex-head', label: 'Hexagonal Head', modifier: 0 }
    ]
  },
  'star-head-cortical-screw': {
    ...
    optionLabels: { material: 'Material', diameter: 'Diameter', option3: 'Length', option4: 'Head Type' },
    material: [
      { value: 'stainless-steel', label: '316L Stainless Steel', modifier: 0 },
    ...
    diameter: [
      ...
      { value: '4.5', label: '4.5 mm', modifier: 0.3, lengths: [
        ...
        { value: '58', label: '58 mm', modifier: 0 },
        { value: '60', label: '60 mm', modifier: 0 },
        { value: '62', label: '62 mm', modifier: 0 },
        { value: '64', label: '64 mm', modifier: 0 },
        { value: '66', label: '66 mm', modifier: 0 },
        { value: '68', label: '68 mm', modifier: 0 },
        { value: '70', label: '70 mm', modifier: 0 },
        { value: '72', label: '72 mm', modifier: 0 },
        { value: '74', label: '74 mm', modifier: 0 },
        { value: '76', label: '76 mm', modifier: 0 },
        { value: '78', label: '78 mm', modifier: 0 },
        { value: '80', label: '80 mm', modifier: 0 },
        { value: '82', label: '82 mm', modifier: 0 },
        { value: '84', label: '84 mm', modifier: 0 },
        { value: '86', label: '86 mm', modifier: 0 },
        { value: '88', label: '88 mm', modifier: 0 },
        { value: '90', label: '90 mm', modifier: 0 },
        { value: '92', label: '92 mm', modifier: 0 },
        { value: '94', label: '94 mm', modifier: 0 },
        { value: '96', label: '96 mm', modifier: 0 },
        { value: '98', label: '98 mm', modifier: 0 },
  ...
  'cannulated-herbert-screw': {
    ...
    diameter: [
      ...
      { value: '3.0', label: '3 mm', modifier: 0, lengths: [
        { value: 'all', label: 'All Lengths', modifier: 0 },
        { value: '18', label: '18 mm', modifier: 0 },
        { value: '20', label: '20 mm', modifier: 0 },
        { value: '22', label: '22 mm', modifier: 0 },
      ...
      { value: '4.5', label: '4.5 mm', modifier: 1.5, lengths: [
        { value: 'all', label: 'All Lengths', modifier: 0 },
        { value: '30', label: '30 mm', modifier: 0 },
        { value: '35', label: '35 mm', modifier: 0 },
        { value: '40', label: '40 mm', modifier: 0 },
        { value: '45', label: '45 mm', modifier: 0 },
        { value: '50', label: '50 mm', modifier: 0 }
      ] },
      { value: '5.5', label: '5.5 mm', modifier: 1.5, lengths: [
        { value: 'all', label: 'All Lengths', modifier: 0 },
        { value: '40', label: '40 mm', modifier: 0 },
        { value: '45', label: '45 mm', modifier: 0 },
        { value: '50', label: '50 mm', modifier: 0 },
        { value: '55', label: '55 mm', modifier: 0 },
        { value: '60', label: '60 mm', modifier: 0 }
      ] },
      { value: '6.5', label: '6.5 mm', modifier: 1.5, lengths: [
        { value: 'all', label: 'All Lengths', modifier: 0 },
        { value: '50', label: '50 mm', modifier: 0 },
        { value: '55', label: '55 mm', modifier: 0 },
        { value: '60', label: '60 mm', modifier: 0 },
        ...
        { value: '70', label: '70 mm', modifier: 0 },
        { value: '75', label: '75 mm', modifier: 0 }
      ] }
    ],
    // Fallback length list used only when Diameter = "All Diameters" (no per-diameter .lengths to read from)
    option3: [
      { value: 'all', label: 'All Lengths', modifier: 0 },
      { value: '14', label: '14 mm', modifier: 0 },
      { value: '16', label: '16 mm', modifier: 0 },
  ...
  'distal-clavicular-locking-plate': {
    ...
    option3: [
      ...
      { value: '7', label: '7 Holes', modifier: 24 },
  ...
  'proximal-humeral-locking-plate-3-5mm': {
    ...
    option3: [
      ...
      { value: '6', label: '6 Holes', modifier: 24 },
      { value: '8', label: '8 Holes', modifier: 32 }
    ],
    option4: [
      { value: 'bulk', label: 'Standard Packing (Non-Sterile, Bulk Box)', modifier: 0 },
  ...
  'clavicle-s-safety-locking-plate-3-5mm': {
    ...
    option3: [
      ...
      { value: '8', label: '8 Holes', modifier: 16 },
      { value: '9', label: '9 Holes', modifier: 24 },
  ...
  'mini-fragment-straight-bridge-plate': {
    ...
    option3: [
      ...
      { value: '8', label: '8 Holes', modifier: 24 },
      { value: '9', label: '9 Holes', modifier: 32 },
  ...
  'dhs-dynamic-hip-lag-screw': {
    ...
    option3: [
      ...
      { value: '75', label: '75 mm', modifier: 0 },
      { value: '80', label: '80 mm', modifier: 0 },
      { value: '85', label: '85 mm', modifier: 0 },
      { value: '90', label: '90 mm', modifier: 0 },
      { value: '95', label: '95 mm', modifier: 0 },
      { value: '100', label: '100 mm', modifier: 0 }
    ],
    option4: [
      { value: 'bulk', label: 'Standard Packing (Non-Sterile, Bulk Box)', modifier: 0 },
  ...
  'cancellous-cannulated-screw-half-thread': {
    basePrice: 1.49,
    optionLabels: { material: 'Material', diameter: 'Diameter', option3: 'Length', option4: 'Thread Type' },
    material: [
      { value: 'stainless-steel', label: 'Stainless Steel 316L', modifier: 0 },
    ...
    diameter: [
      ...
      { value: '4.5', label: '4.5 mm', modifier: 0, lengths: [
        { value: '20', label: '20 mm', modifier: 0 },
        { value: '22', label: '22 mm', modifier: 0 },
        { value: '24', label: '24 mm', modifier: 0 },
        { value: '26', label: '26 mm', modifier: 0 },
      ...
      { value: '6.5', label: '6.5 mm', modifier: 0, lengths: [
        { value: '60', label: '60 mm', modifier: 0 },
        { value: '65', label: '65 mm', modifier: 0 },
        { value: '70', label: '70 mm', modifier: 0 },
        { value: '75', label: '75 mm', modifier: 0 },
        ...
        { value: '95', label: '95 mm', modifier: 0 },
        { value: '100', label: '100 mm', modifier: 0 },
        { value: '105', label: '105 mm', modifier: 0 },
        { value: '110', label: '110 mm', modifier: 0 },
        { value: '115', label: '115 mm', modifier: 0 },
        { value: '120', label: '120 mm', modifier: 0 },
        { value: '125', label: '125 mm', modifier: 0 },
        { value: '130', label: '130 mm', modifier: 0 }
      ] },
      { value: '7.3', label: '7.3 mm', modifier: 0, lengths: [
        { value: '60', label: '60 mm', modifier: 0 },
        { value: '65', label: '65 mm', modifier: 0 },
        { value: '70', label: '70 mm', modifier: 0 },
        { value: '75', label: '75 mm', modifier: 0 },
    ...
    option4: [
      { value: 'full-thread', label: 'Full Thread', modifier: 0 },
      { value: 'half-thread', label: 'Half Thread', modifier: 0 }
    ]
  },
  'cmf-maxillofacial-cross-drive-mini-screw': {
    basePrice: 1.09,
    optionLabels: { material: 'Material', diameter: 'Diameter', option3: 'Length', option4: 'Type' },
    material: [
      { value: 'stainless-steel', label: 'Stainless Steel 316L', modifier: 0 },
    ...
    option4: [
      { value: 'self-tapping', label: 'Self-Tapping', modifier: 0 },
      { value: 'self-drilling', label: 'Self-Drilling', modifier: 0 }
    ]
  },
  'distal-fibula-lcp-plate': {
    ...
    option3: [
      ...
      { value: '8', label: '8 Holes', modifier: 40 },
      { value: '9', label: '9 Holes', modifier: 48 },
  ...
  'veterinary-lc-dcp-t-plate': {
    ...
    option3: [
      ...
      { value: '8', label: '8 Holes', modifier: 18 },
      { value: '9', label: '9 Holes', modifier: 24 },
  ...
  'radius-t-titanium-locking-plate-3-5mm': {
    ...
    material: [
      { value: 'titanium', label: 'Titanium (Ti-6Al-4V)', modifier: 0 },
      { value: 'stainless-steel', label: 'Stainless Steel 316L', modifier: -5 }
    ],
  ...
  'distal-ulna-hook-locking-plate': {
    ...
    material: [
      { value: 'titanium', label: 'Titanium (Ti-6Al-4V)', modifier: 0 },
      { value: 'stainless-steel', label: 'Stainless Steel 316L', modifier: -4 }
    ],
  ...
  'double-ended-kirschner-k-wire': {
    ...
    diameter: [
      ...
      { value: '1.8', label: '1.8 mm', modifier: 0.05 },
      { value: '2.0', label: '2.0 mm', modifier: 0.1 },
      { value: '2.5', label: '2.5 mm', modifier: 0.1 },
    ...
    option3: [
      ...
      { value: '310', label: '310 mm', modifier: 0.15 }
    ],
    option4: [
      { value: 'trocar', label: 'Trocar (Double-Ended)', modifier: 0 },
      { value: 'diamond', label: 'Diamond Tip (Double-Ended)', modifier: 0.05 }
    ]
  },
  'austin-moore-hip-prosthesis': {
    ...
    option3: [
      { value: 'short', label: 'Short Stem', modifier: 0 },
  ...
  'plate-bending-plier': {
    basePrice: 38,
    optionLabels: { material: 'Material', diameter: 'Jaw Size', option3: 'Handle Length', option4: 'Set Type' },
    material: [{ value: 'stainless-steel', label: 'Surgical Stainless Steel', modifier: 0 }],
    diameter: [
      { value: 'small', label: 'Small Fragment', modifier: 0 },
    ...
    option4: [
      { value: 'single', label: 'Single Plier', modifier: 0 },
      { value: 'set', label: 'Full Bending Set (3-piece)', modifier: 45 }
    ]
  },
